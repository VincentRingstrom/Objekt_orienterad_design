...
public class ItemDTO {
    ...
    /**
     * Creates an ItemDTO instance that is read only and used to transfer Item data.
     * @param name - The name of the instance
     * @param price - The price of the instance
     * @param VAT - The VAT of the instance
     * @param barCode - The bar-code of the instance
     */
    ...
    /**
     * This method reads ItemDTO's bar-code.
     * @return The bar-code.
     */
